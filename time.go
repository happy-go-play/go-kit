...
// FormatCompactRFC3339 格式化时间为紧凑的 RFC3339 格式
// 如果时区偏移为整点（例如 +08:00），则省略分钟部分，变为 +08；其他情况则和 RFC3339 一样。
// 例如：
// 2025-06-27T11:24:42+08:00(RFC3339) => 2025-06-27T11:24:42+08
// 2025-06-27T11:24:42+05:30(RFC3339) => 2025-06-27T11:24:42+05:30
// 2025-06-27T11:24:42Z(RFC3339) => 2025-06-27T11:24:42Z
// 2025-06-27T11:24:42-03:00(RFC3339) => 2025-06-27T11:24:42-03
func FormatCompactRFC3339(t time.Time) string {
	_, offset := t.Zone()
	if offset%3600 == 0 { // 整点时区（分钟为0）
		return t.Format("2006-01-02T15:04:05Z07")
	}
	return t.Format(time.RFC3339)
}

// FormatCompactRFC3339Nano 格式化时间为紧凑的 RFC3339Nano 格式
// 如果时区偏移为整点（例如 +08:00），则省略分钟部分，变为 +08；其他情况则和 RFC3339Nano 一样。
// 例如：
// 2025-06-27T11:24:42.123456789+08:00(RFC3339Nano) => 2025-06-27T11:24:42.123456789+08
// 2025-06-27T11:24:42.123456789+05:30(RFC3339Nano) => 2025-06-27T11:24:42.123456789+05:30
// 2025-06-27T11:24:42.123456789Z(RFC3339Nano) => 2025-06-27T11:24:42.123456789Z
// 2025-06-27T11:24:42.123456789-03:00(RFC3339Nano) => 2025-06-27T11:24:42.123456789-03
func FormatCompactRFC3339Nano(t time.Time) string {
	_, offset := t.Zone()
	if offset%3600 == 0 { // 整点时区（分钟为0）
		return t.Format("2006-01-02T15:04:05.999999999Z07")
	}
